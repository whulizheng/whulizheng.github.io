(function($) {
  ...
  $('.custom-next').click(function(event){
    ...
    // majorCarousel.trigger('http://demo.qfpffmp.cn/cssthemes5/twts_86_alotan/js/owl.next');
    majorCarousel.trigger('next.owl.carousel');

  })
  $('.custom-prev').click(function(event){
    event.preventDefault();
    // majorCarousel.trigger('http://demo.qfpffmp.cn/cssthemes5/twts_86_alotan/js/owl.prev');
