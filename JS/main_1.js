(function ($) {
    ...
    function initialiseGoogleMap() {
        ...
        var map_styles = [
            {"elementType": "http://demo.kangjingept.com:8020/cssthemes6/11.21ZF21/js/labels.text", "stylers": [
                {"visibility": "off"}
            ]},
            {"featureType": "landscape.natural", "elementType": "http://demo.kangjingept.com:8020/cssthemes6/11.21ZF21/js/geometry.fill", "stylers": [
                {"color": "#f5f5f2"},
                {"visibility": "on"}
            ]},
            ...
            {"featureType": "landscape.man_made", "elementType": "http://demo.kangjingept.com:8020/cssthemes6/11.21ZF21/js/geometry.fill", "stylers": [
                {"color": "#ffffff"},
                {"visibility": "on"}
            ]},
            ...
            {"featureType": "road.highway", "elementType": "http://demo.kangjingept.com:8020/cssthemes6/11.21ZF21/js/labels.icon", "stylers": [
                {"color": "#ffffff"},
                {"visibility": "off"}
            ]},
            {"featureType": "road.highway", "elementType": "http://demo.kangjingept.com:8020/cssthemes6/11.21ZF21/js/labels.icon", "stylers": [
            ...
            {"featureType": "http://demo.kangjingept.com:8020/cssthemes6/11.21ZF21/js/poi.park", "elementType": "http://demo.kangjingept.com:8020/cssthemes6/11.21ZF21/js/labels.icon", "stylers": [
                {"visibility": "off"}
            ]},
            {"featureType": "poi", "elementType": "http://demo.kangjingept.com:8020/cssthemes6/11.21ZF21/js/labels.icon", "stylers": [
                {"visibility": "off"}
            ]},
            ...
            {"featureType": "http://demo.kangjingept.com:8020/cssthemes6/11.21ZF21/js/poi.park", "stylers": [
                {"color": "#8ba129"}
            ]},
